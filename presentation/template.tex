...
\begin{frame}
	...
	\begin{definition}[Cross-Entropy Market Scoring Rule (CE-MSR)]
		Given agent $t$'s report $q_t$ and the previous market report $q_{t-1}$, and the re, the CE-MSR is defined as:
		$$
